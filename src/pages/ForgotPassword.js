...
const ForgotPassword = () => {
  ...
  const content = {
    np: {
      ...
      demoNote: 'डेमो इमेलहरू: user@example.com, test@ntc.com, admin@ntc.net.np | OTP: 123456'
    },
    en: {
      ...
      demoNote: 'Demo emails: user@example.com, test@ntc.com, admin@ntc.net.np | OTP: 123456'
    }
  };
  ...
  const handleResendOtp = () => {
    ...
    setTimeout(() => {
      ...
      setLoading(false);
      startResendTimer(30);
      console.log(`OTP resent to ${email}: 123456`);
    }, 1000);
  };
        ...
        <div className="forgot-container">
          <div className="forgot-card">
            <div className="forgot-header">
              ...
              <p>{step === 1 ? t.weWillSendOtp : (step === 2 ? t.enterOtp : t.resetPassword)}</p>
            </div>
            ...
            {step === 2 && (
              <form onSubmit={handleVerifyOtp} className="forgot-form">
                ...
                <button type="submit" className="btn-submit" disabled={loading}>
                  {loading ? <span className="loading-spinner"></span> : null}
                  {loading ? (language === 'np' ? 'प्रमाणित गर्दै...' : 'Verifying...') : t.verifyOtp}
                </button>
            ...
            {step === 3 && (
              <form onSubmit={handleResetPassword} className="forgot-form">
                ...
                <button type="submit" className="btn-submit" disabled={loading}>
                  {loading ? <span className="loading-spinner"></span> : null}
                  {loading ? (language === 'np' ? 'रिसेट गर्दै...' : 'Resetting...') : t.resetPasswordBtn}
                </button>
              </form>
            )}
