...
const AdminComplaintsResolved = () => {
  ...
  const [complaints, setComplaints] = useState([
    { 
      ...
      resolutionTime: '2 दिन',
      enResolutionTime: '2 days',
    ...
    { 
      ...
      assignedTo: 'बिलिङ टोली',
      enAssignedTo: 'Billing Team',
      resolutionTime: '5 दिन',
      enResolutionTime: '5 days',
    ...
    { 
      ...
      assignedTo: 'बिलिङ टोली',
      enAssignedTo: 'Billing Team',
      resolutionTime: '3 दिन',
      enResolutionTime: '3 days',
      satisfactionRating: 5,
      feedback: 'बिल समायोजन भयो, धन्यवाद',
      enFeedback: 'Bill adjusted, thank you'
    },
    { 
      id: 4, 
      ticketId: 'NTC-2024-018', 
      name: 'कृष्ण भण्डारी', 
      enName: 'Krishna Bhandari',
      email: 'krishna@example.com',
      phone: '9841234987',
      category: 'internet',
      category_np: 'इन्टरनेट',
      category_en: 'Internet',
      description: 'इन्टरनेट जडान समस्या समाधान गरिदिनुहोस्',
      enDescription: 'Please resolve internet connection issue',
      status: 'resolved',
      date: '२०८०-०२-०५',
      enDate: '2024-02-05',
      resolvedDate: '२०८०-०२-०८',
      enResolvedDate: '2024-02-08',
      ...
      enResolutionTime: '3 days',
      satisfactionRating: 5,
      feedback: 'जडान सहि भयो, स्पीड पनि राम्रो छ',
      enFeedback: 'Connection fixed, speed is good'
    },
    { 
      id: 5, 
      ticketId: 'NTC-2024-019', 
      name: 'उषा परियार', 
      enName: 'Usha Pariat',
      ...
      description: 'नयाँ सिम सक्रिय गर्न समस्या',
      enDescription: 'Issue activating new SIM',
      status: 'resolved',
      date: '२०८०-०२-०८',
      enDate: '2024-02-08',
      resolvedDate: '२०८०-०२-१०',
      enResolvedDate: '2024-02-10',
      channel: 'फोन',
      enChannel: 'Phone',
      priority: 'high',
      ...
      enResolutionTime: '2 days',
      satisfactionRating: 4,
      feedback: 'सिम सक्रिय भयो',
      enFeedback: 'SIM activated'
    },
    { 
      id: 6, 
      ticketId: 'NTC-2024-020', 
      name: 'दीपेन्द्र श्रेष्ठ', 
      enName: 'Dipendra Shrestha',
      email: 'dipendra@example.com',
      phone: '9845123789',
      category: 'network',
      category_np: 'नेटवर्क',
      category_en: 'Network',
      description: 'नेटवर्क कभरेज समस्या',
      enDescription: 'Network coverage issue',
      status: 'resolved',
      date: '२०८०-०२-०१',
      enDate: '2024-02-01',
      resolvedDate: '२०८०-०२-१८',
      enResolvedDate: '2024-02-18',
      channel: 'फेसबुक',
      enChannel: 'Facebook',
      priority: 'low',
      assignedTo: 'नेटवर्क टोली',
      enAssignedTo: 'Network Team',
      resolutionTime: '17 दिन',
      enResolutionTime: '17 days',
      satisfactionRating: 3,
      feedback: 'समस्या समाधान भयो तर समय लाग्यो',
      enFeedback: 'Issue resolved but took time'
    },
    { 
      id: 7, 
      ticketId: 'NTC-2024-021', 
      name: 'रिता गुरुङ', 
      enName: 'Rita Gurung',
      ...
      description: 'एपमा लगइन समस्या',
      enDescription: 'Login issue in app',
      status: 'resolved',
      date: '२०८०-०२-१४',
      enDate: '2024-02-14',
      resolvedDate: '२०८०-०२-१६',
      enResolvedDate: '2024-02-16',
      channel: 'वेबसाइट पोर्टल',
      enChannel: 'Website Portal',
      priority: 'medium',
      assignedTo: 'प्राविधिक टोली',
      ...
      enResolutionTime: '2 days',
      satisfactionRating: 5,
      feedback: 'एप सहि भयो, अहिले राम्रोसँग चलिरहेको छ',
      enFeedback: 'App fixed, working well now'
    }
  ]);
  ...
  const getFilteredByTimeRange = (complaintsList) => {
    ...
    return complaintsList.filter(complaint => {
      const resolvedDate = new Date(complaint.enResolvedDate);
  ...
  const avgResolutionDays = totalResolved > 0 
    ? Math.round(filteredComplaints.reduce((sum, c) => {
        const resolutionTime = parseInt(c.resolutionTime);
        return sum + (isNaN(resolutionTime) ? 0 : resolutionTime);
      }, 0) / totalResolved)
    : 0;
  const avgSatisfaction = totalResolved > 0 
    ? (filteredComplaints.reduce((sum, c) => sum + c.satisfactionRating, 0) / totalResolved).toFixed(1)
    : 0;
                ...
                {paginatedComplaints.length > 0 ? (
                  paginatedComplaints.map((complaint) => (
                    <tr key={complaint.id}>
                      ...
                      <td>{getDate(complaint, 'resolvedDate')}</td>
                      <td>{language === 'np' ? complaint.resolutionTime : complaint.enResolutionTime}</td>
                      <td>
          ...
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-body">
              ...
              <div className="detail-row">
                ...
                <span>{getDate(selectedComplaint, 'resolvedDate')}</span>
              </div>
              <div className="detail-row">
                <label>{t.resolutionTime}:</label>
                <span>{language === 'np' ? selectedComplaint.resolutionTime : selectedComplaint.enResolutionTime}</span>
              </div>
              <div className="detail-row">
