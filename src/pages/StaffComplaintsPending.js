// src/pages/StaffComplaintsPending.js
...
const StaffComplaintsPending = () => {
  ...
  const fetchPendingComplaints = async () => {
    ...
    try {
      ...
      const response = await axios.get('http://localhost:5000/api/complaints/pending', {
      ...
      if (response.data.success && Array.isArray(response.data.data)) {
        ...
        calculateStats(getSamplePendingComplaints());
  ...
  // Get sample pending complaints with multiple staff assignments
  const getSamplePendingComplaints = () => {
    return [
      { 
        ...
        description: 'नयाँ सिम खरिद गरेको २४ घण्टा भयो तर सक्रिय भएको छैन। कृपया छिटो समाधान गरिदिनुहोस्।',
        enDescription: 'Purchased new SIM 24 hours ago but not activated yet. Please resolve quickly.',
        status: 'pending',
        date: '२०८०-०२-०१',
        enDate: '2024-02-01',
        channel: 'फोन',
        ...
        landmark: 'Near Maitidevi Temple',
        assignedBy: 'Admin',
      ...
      { 
        ...
        description: 'मेरो बिलमा रु. १५०० गलत चार्ज देखाइएको छ। कृपया जाँच गर्नुहोस्।',
        enDescription: 'Wrong charge of Rs. 1500 shown in my bill. Please check.',
        status: 'pending',
        date: '२०८०-०२-१८',
        enDate: '2024-02-18',
        channel: 'इमेल',
      ...
      { 
        ...
        description: 'इन्टरनेट जडान नियमित रूपमा डिस्कनेक्ट भइरहेको छ। दिनमा १०-१५ पटक जडान जान्छ।',
        enDescription: 'Internet connection is disconnecting regularly. 10-15 times per day.',
        status: 'pending',
        date: '२०८०-०२-२२',
        enDate: '2024-02-22',
      ...
      { 
        ...
        description: 'रु. २०० को रिचार्ज गर्दा रु. ५०० कटौती भयो। कृपया रकम फिर्ता गरिदिनुहोस्।',
        enDescription: 'Rs. 500 deducted for Rs. 200 recharge. Please refund.',
        status: 'pending',
        date: '२०८०-०३-०५',
        enDate: '2024-03-05',
        channel: 'व्हाट्सएप',
  ...
  // Sort by priority (urgent/high first, then medium, then low) and then by days pending (oldest first)
  ...
  return (
    <div className="staff-complaints-pending">
      <StaffHeader 
        language={language}
        ...
        <div className="main-content">
          <div className="content-wrapper">
            ...
            <div className="welcome-section">
              <div>
                <h1 className="welcome-title">{t.pendingComplaints}</h1>
                <p className="welcome-subtitle">{t.pageTitle}</p>
              </div>
              <button className="refresh-btn" onClick={fetchPendingComplaints}>
                🔄 {t.refresh}
              </button>
            </div>
                  ...
                  {paginatedComplaints.length > 0 ? (
                    paginatedComplaints.map((complaint) => (
                      <tr key={complaint.id}>
                        ...
                        <td>
                          <span className={`days-badge ${complaint.daysPending > 7 ? 'days-warning' : complaint.daysPending > 3 ? 'days-caution' : ''}`}>
                            {complaint.daysPending} {t.days}
                          </span>
                        </td>
                        <td>
            ...
            <div className="modal-body">
              <div className="detail-section">
                ...
                <div className="detail-row">
                  ...
                  <span className={`days-badge ${selectedComplaint.daysPending > 7 ? 'days-warning' : selectedComplaint.daysPending > 3 ? 'days-caution' : ''}`}>
                    {selectedComplaint.daysPending} {t.days}
                  </span>
                </div>
                <div className="detail-row">
...
export default StaffComplaintsPending;